...
//
  ...
  SEGGER_RTT_PUT_BUFFER_SECTION(SEGGER_RTT_BUFFER_ALIGN(__attribute__((section (".RAM_D2")))static char _acUpBuffer  [BUFFER_SIZE_UP]));
  SEGGER_RTT_PUT_BUFFER_SECTION(SEGGER_RTT_BUFFER_ALIGN(__attribute__((section (".RAM_D2")))static char _acDownBuffer[BUFFER_SIZE_DOWN]));
#endif

__attribute__((section (".RAM_D2")))static unsigned char _ActiveTerminal;
